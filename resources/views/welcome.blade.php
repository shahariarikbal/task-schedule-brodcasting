                            ...
                            <div class="dropdown profile-nav-item">
                                <a href="#" class="dropdown-bs-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <div class="menu-profile">
                                        <img src="{{ asset('/frontend/') }}/assets/images/user/user-1.jpg" class="rounded-circle" alt="image">
                                ...
                                <div class="dropdown-menu">
                                    <div class="profile-header">
                                        ...
                                        <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#c5a8a4b1b1ada0b2f0f5f285a2a8a4aca9eba6aaa8"><span class="__cf_email__" data-cfemail="305d51444458554705000770575d51595c1e535f5d">[email&#160;protected]</span></a>
                                    </div>
                            ...
                            <div class="option-item">
                                <div class="dropdown profile-nav-item">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="profile-header">
                                            <h3>Matthew Turner</h3>
                                            <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#c5a8a4b1b1ada0b2f0f5f285a2a8a4aca9eba6aaa8"><span class="__cf_email__" data-cfemail="0964687d7d616c7e3c393e496e64686065276a6664">[email&#160;protected]</span></a>
                                        </div>
                                        <ul class="profile-body">
                                            <li><i class="flaticon-user"></i> <a href="my-profile.html">My Profile</a></li>
                                            <li><i class="flaticon-settings"></i> <a href="setting.html">Setting</a></li>
                ...
                <aside class="widget-area">
                    <div class="widget widget-view-profile">
                        <div class="profile-box d-flex justify-content-between align-items-center">
                            <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-1.jpg" alt="image"></a>
                            <div class="text ms-2">
                        ...
                        <div class="profile-likes">
                            ...
                            <ul>
                                <li>
                                    <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/user/user-22.jpg" alt="image"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/user/user-23.jpg" alt="image"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/user/user-24.jpg" alt="image"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/user/user-25.jpg" alt="image"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/user/user-26.jpg" alt="image"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/user/user-27.jpg" alt="image"></a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="widget widget-watch-video">
                        ...
                        <div class="watch-video-slides owl-carousel owl-theme">
                            <div class="video-item">
                                <img src="{{ asset('/frontend/') }}/assets/images/watch-video/video-1.jpg" alt="image">
                            ...
                            <div class="video-item">
                                <img src="{{ asset('/frontend/') }}/assets/images/watch-video/video-2.jpg" alt="image">
                            ...
                            <div class="video-item">
                                <img src="{{ asset('/frontend/') }}/assets/images/watch-video/video-3.jpg" alt="image">
                    ...
                    <div class="widget widget-advertisement">
                        ...
                        <div class="advertisement-image">
                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/advertisement.jpg" alt="image"></a>
                        </div>
                    </div>
                ...
                <div class="news-feed-area">
                    ...
                    <div class="news-feed news-feed-post">
                        <div class="post-header d-flex justify-content-between align-items-center">
                            <div class="image">
                                <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-32.jpg" class="rounded-circle" alt="image"></a>
                            </div>
                            <div class="info ms-3">
                        ...
                        <div class="post-body">
                            ...
                            <div class="post-image">
                                <img src="{{ asset('/frontend/') }}/assets/images/news-feed-post/post-1.jpg" alt="image">
                            </div>
                            <ul class="post-meta-wrap d-flex justify-content-between align-items-center">
                                <li class="post-react">
                                    ...
                                    <ul class="react-list">
                                        <li>
                                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/react/react-1.png" alt="Like"></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/react/react-2.png" alt="Like"></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/react/react-3.png" alt="Like"></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/react/react-4.png" alt="Like"></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/react/react-5.png" alt="Like"></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/react/react-6.png" alt="Like"></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/react/react-7.png" alt="Like"></a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <div class="post-comment-list">
                                <div class="comment-list">
                                    <div class="comment-image">
                                        <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-33.jpg" class="rounded-circle" alt="image"></a>
                                    </div>
                                ...
                                <div class="comment-list">
                                    <div class="comment-image">
                                        <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-34.jpg" class="rounded-circle" alt="image"></a>
                                    </div>
                                    <div class="comment-info">
                                        <h3>
                                ...
                                <div class="comment-list">
                                    <div class="comment-image">
                                        <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-8.jpg" class="rounded-circle" alt="image"></a>
                                    </div>
                                    <div class="comment-info">
                                        <h3>
                    ...
                    <div class="news-feed news-feed-post">
                        <div class="post-header d-flex justify-content-between align-items-center">
                            <div class="image">
                                <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-35.jpg" class="rounded-circle" alt="image"></a>
                            </div>
                            <div class="info ms-3">
                        ...
                        <div class="post-body">
                            <p>💗</p>
                            <div class="post-image">
                                <img src="{{ asset('/frontend/') }}/assets/images/news-feed-post/post-2.jpg" alt="image">
                            </div>
                            <ul class="post-meta-wrap d-flex justify-content-between align-items-center">
                                <li class="post-react">
                    ...
                    <div class="news-feed news-feed-post">
                        <div class="post-header d-flex justify-content-between align-items-center">
                            <div class="image">
                                <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-36.jpg" class="rounded-circle" alt="image"></a>
                            </div>
                            <div class="info ms-3">
                        ...
                        <div class="post-body">
                            <p>Keep Smiling 🧡</p>
                            <div class="post-image">
                                <img src="{{ asset('/frontend/') }}/assets/images/news-feed-post/post-3.jpg" alt="image">
                            </div>
                            <ul class="post-meta-wrap d-flex justify-content-between align-items-center">
                                <li class="post-react">
                    ...
                    <div class="news-feed news-feed-post">
                        <div class="post-header d-flex justify-content-between align-items-center">
                            <div class="image">
                                <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-5.jpg" class="rounded-circle" alt="image"></a>
                            </div>
                            <div class="info ms-3">
                        ...
                        <div class="post-body">
                            ...
                            <div class="post-image">
                                <img src="{{ asset('/frontend/') }}/assets/images/news-feed-post/post-4.jpg" alt="image">
                            </div>
                            <ul class="post-meta-wrap d-flex justify-content-between align-items-center">
                                <li class="post-react">
                                    <a href="#"><i class="flaticon-like"></i><span>Like</span> <span class="number">1499 </span></a>
                            ...
                            <div class="post-comment-list">
                                <div class="comment-list">
                                    <div class="comment-image">
                                        <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-14.jpg" class="rounded-circle" alt="image"></a>
                                    </div>
                                    <div class="comment-info">
                                        <h3>
                                            <a href="my-profile.html">David Moore</a>
                                ...
                                <div class="comment-list">
                                    <div class="comment-image">
                                        <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-15.jpg" class="rounded-circle" alt="image"></a>
                                    </div>
                                    <div class="comment-info">
                                        <h3>
                                            <a href="my-profile.html">Claire P. Toy</a>
                                ...
                                <div class="comment-list">
                                    <div class="comment-image">
                                        <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-16.jpg" class="rounded-circle" alt="image"></a>
                                    </div>
                                    <div class="comment-info">
                                        <h3>
                                            <a href="my-profile.html">Karen Williams</a>
                    ...
                    <div class="news-feed news-feed-post">
                        <div class="post-header d-flex justify-content-between align-items-center">
                            <div class="image">
                                <a href="my-profile.html"><img src="{{ asset('/frontend/') }}/assets/images/user/user-18.jpg" class="rounded-circle" alt="image"></a>
                            </div>
                            <div class="info ms-3">
                                <span class="name"><a href="my-profile.html">Maria Dodson</a></span>
                                <span class="small-text"><a href="#">2 Hours Ago</a></span>
                        ...
                        <div class="post-body">
                            ...
                            <div class="post-image">
                                <img src="{{ asset('/frontend/') }}/assets/images/news-feed-post/post-5.jpg" alt="image">
                            </div>
                            <ul class="post-meta-wrap d-flex justify-content-between align-items-center">
                                <li class="post-react">
                                    <a href="#"><i class="flaticon-like"></i><span>Like</span> <span class="number">15 </span></a>
                ...
                <aside class="widget-area">
                    <div class="widget widget-weather">
                        <div class="weather-image">
                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/weather/weather.jpg" alt="image"></a>
                        </div>
                    </div>
                    ...
                    <div class="widget widget-explore-events">
                        ...
                        <article class="item">
                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/explore-events/explore-1.jpg" alt="image"></a>
                        </article>
                        <article class="item">
                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/explore-events/explore-2.jpg" alt="image"></a>
                        </article>
                    </div>
                    <div class="widget widget-who-following">
                        ...
                        <div class="following-item d-flex justify-content-between align-items-center">
                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/user/user-44.jpg" class="rounded-circle" alt="image"></a>
                            <span class="name"><a href="#">Janet Suarez</a></span>
                            <span class="add-friend"><a href="#">Add</a></span>
                        </div>
                        <div class="following-item d-flex justify-content-between align-items-center">
                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/user/user-45.jpg" class="rounded-circle" alt="image"></a>
                            <span class="name"><a href="#">Brian Mingo</a></span>
                            <span class="add-friend"><a href="#">Add</a></span>
                        </div>
                        <div class="following-item d-flex justify-content-between align-items-center">
                            <a href="#"><img src="{{ asset('/frontend/') }}/assets/images/user/user-46.jpg" class="rounded-circle" alt="image"></a>
...
<!-- Mirrored from templates.envytheme.com/zust/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 May 2022 21:08:00 GMT -->
</html>
